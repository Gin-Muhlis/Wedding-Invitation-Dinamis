              ...
              <div id="carouselExampleIndicators" class="carousel slide">
                  <div class="d-flex justify-content-center align-items-center gap-2">
                      <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0"
                          class="btn-pakai-foto btn-indicators active" aria-current="true" aria-label="Slide 1">
                              ...
                              @foreach ($data_katalog['theme_with_foto'] as $theme)
                                  <div class="col-md-4 mb-4">
                                      <div class="card">
                                          ...
                                          <div
                                              class="card-body py-3 d-flex align-items-center justify-content-center gap-2 w-100">
