                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                <div
                                    ...
                                    class="btn-group"
                                >
                                    @can('update', $invitedGuest)
                                    <a
                                        href="{{ route('invited-guests.edit', $invitedGuest) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('view', $invitedGuest)
                                    <a
                                        href="{{ route('invited-guests.show', $invitedGuest) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('delete', $invitedGuest)
                                    <form
                                        action="{{ route('invited-guests.destroy', $invitedGuest) }}"
                                        method="POST"
