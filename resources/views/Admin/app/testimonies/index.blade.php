        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    @endcan @can('view', $testimony)
                                    <a
                                        href="{{ route('testimonies.show', $testimony) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('delete', $testimony)
                                    <form
                                        action="{{ route('testimonies.destroy', $testimony) }}"
                                        method="POST"
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="5">{!! $testimonies->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
