    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">
                ...
                ></a>
                @lang('crud.rsvps.show_title')
            </h4>

            <div class="mt-4">
                <div class="mb-4">
                    <h5>@lang('crud.rsvps.inputs.name')</h5>
                    <span>{{ $rsvp->name ?? '-' }}</span>
                </div>
                <div class="mb-4">
                    <h5>@lang('crud.rsvps.inputs.comment')</h5>
                    <span>{{ $rsvp->comment ?? '-' }}</span>
                </div>
                <div class="mb-4">
                    <h5>@lang('crud.rsvps.inputs.kehadiran')</h5>
                    <span>{{ $rsvp->kehadiran ?? '-' }}</span>
                </div>
                <div class="mb-4">
                    <h5>@lang('crud.rsvps.inputs.order_id')</h5>
