    ...
    <div class="searchbar mt-0 mb-4">
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                ...
                <a href="{{ route('rsvps.create') }}" class="btn btn-primary">
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    @endcan @can('view', $rsvp)
                                    <a href="{{ route('rsvps.show', $rsvp) }}">
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                        >
                                    ...
                                    @endcan @can('delete', $rsvp)
                                    <form
                                        action="{{ route('rsvps.destroy', $rsvp) }}"
                                        method="POST"
