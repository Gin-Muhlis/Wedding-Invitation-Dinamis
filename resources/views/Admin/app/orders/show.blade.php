...
<div class="container">
    <div class="card">
        <div class="card-body">
            ...
            <div class="mt-4">
                <div class="mb-4">
                    <h5>@lang('crud.orders.inputs.no_order')</h5>
                    <span>{{ $order->no_order ?? '-' }}</span>
                </div>
                <div class="mb-4">
                    <h5>@lang('crud.orders.inputs.order_date')</h5>
                    <span>{{ $order->order_date ?? '-' }}</span>
                </div>
                <div class="mb-4">
                    <h5>@lang('crud.orders.inputs.domain')</h5>
                    <span>{{ $order->domain ?? '-' }}</span>
                </div>
                <div class="mb-4">
                    <h5>@lang('crud.orders.inputs.total_order')</h5>
                ...
                <div class="mb-4">
                    <h5>@lang('crud.orders.inputs.theme_id')</h5>
                    <span
